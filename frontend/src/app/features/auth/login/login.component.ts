    ...
    <div style="display:flex;min-height:100vh;background:var(--bg);">
      ...
      <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:32px 24px;">
        <div style="width:100%;max-width:380px;">
          ...
          <h1 style="font-size:26px;font-weight:800;color:var(--text);margin:0 0 6px;">Welcome back</h1>
          <p style="font-size:14px;color:var(--dim);margin:0 0 32px;">Sign in to your workspace.</p>
          ...
          <form [formGroup]="form" (ngSubmit)="submit()">
            ...
            <div style="margin-bottom:24px;">
              ...
              />
              @if (dirty('password')) {
                <p style="font-size:12px;color:#e5484d;margin:4px 0 0;">Password is required.</p>
              }
            </div>
          ...
          <p style="text-align:center;font-size:13px;color:var(--dim);margin-top:24px;">
            No account?
            <a routerLink="/register" style="color:var(--accent);font-weight:600;text-decoration:none;">Register</a>
          </p>
        </div>
      </div>
    </div>
